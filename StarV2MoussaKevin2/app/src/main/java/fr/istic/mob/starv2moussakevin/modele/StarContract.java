...
public interface StarContract {
    ...
    interface BusRoutes {
        ...
        String CONTENT_ITEM_TYPE =
                "vnd.android.cursor.item/vnd.fr.istic.mob.starv1moussakevin.busroute";
    ...
    interface Trips {
        ...
        String CONTENT_ITEM_TYPE =
                "vnd.android.cursor.item/vnd..trip";
    ...
    interface Calendar {
        ...
        Uri CONTENT_URI = Uri.withAppendedPath(AUTHORITY_URI, CONTENT_PATH);
        String CONTENT_TYPE =
                "vnd.android.cursor.dir/vnd.fr.istic.mob.starv1moussakevinH.calendar";
        String CONTENT_ITEM_TYPE =
    ...
    interface RoutesForStop {
        ...
        Uri CONTENT_URI = Uri.withAppendedPath(AUTHORITY_URI, CONTENT_PATH);
        String CONTENT_TYPE = "vnd.android.cursor.dir/vnd..routesForStop";
        String CONTENT_ITEM_TYPE = "vnd.android.cursor.item/vnd.fr.istic.mob.starv1moussakevin.routesForStop";

        interface RoutesForStopColumns extends BaseColumns {
            String SHORT_NAME = "route_short_name";
        }
    }
}
